...
module.exports.aws_key = "AKIAI3TE2KLVIZ37LRUA" # AWS Key
module.exports.aws_secret = "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" # AWS Secret
module.exports.aws_bucket = "wired200" # AWS Bucket
